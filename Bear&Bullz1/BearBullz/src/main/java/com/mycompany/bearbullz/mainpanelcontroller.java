...
public class mainpanelcontroller {
   ...
   Label Balance;
    ...
    public void portfolio(ActionEvent e) throws IOException
    {
    ...
    // Assuming Canvas is a BorderPane (or another Pane type)
    Canvas.setCenter(root);
    Canvas.getStylesheets().add(getClass().getResource("portfolio.css").toExternalForm());
    ...
    public void profile(ActionEvent e) throws IOException
    {
       ...
       FXMLLoader loader = new FXMLLoader(getClass().getResource("profile.fxml"));
        Parent root= loader.load();
        ProfileController hpc = loader.getController();
        hpc.setGmail(Gmail);
        //hpc.Gmail=Gmail;
    ...
    // Assuming Canvas is a BorderPane (or another Pane type)
    Canvas.setCenter(root);
    Canvas.getStylesheets().add(getClass().getResource("profile.css").toExternalForm());
